...
const chapterData = [
	...
	{
		title: "Chapter 2: Learning more on React",
		summary:
		...
		<div>
			...
			<Accordion
				...
				<AccordionItem value={`item-${chapter.chapter}`} className="border-b">
					<AccordionTrigger className="rounded-none border-b text-accent hover:bg-accent-foreground px-20 flex items-center" style={{backgroundColor: background}}>
						<h2 className="font-normal text-8xl tracking-tighter">{chapter.title.toUpperCase()}</h2>
					</AccordionTrigger>
