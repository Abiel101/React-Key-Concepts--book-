	...
	return (
		<AnimatePageTransition type="landingPage">
			...
			<div className="w-screen h-screen bg-primary flex flex-col items-center justify-center text-center text-foreground relative">
				<h1 className="text-[150px] text-shadow-lg leading-30 lg:leading-50 lg:text-[248px] thunder-bold font-black text-background">
				...
				{/* ============================== Message animation ============================= */}
				<motion.div
					className="max-w-150 lg:max-w-200 bg-background text-xs lg:text-sm font-light rounded-full bottom-30 lg:bottom-90 overflow-hidden flex items-center justify-center cursor-pointer absolute"
					style={{
