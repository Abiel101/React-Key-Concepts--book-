  ...
  return (
    <AnimatePageTransition type="landingPage">
      <div className="w-screen h-screen bg-primary flex flex-col items-center justify-center text-center text-foreground relative">
        <h1 className="text-[150px] text-shadow-lg leading-30 lg:text-[248px] thunder-bold font-black text-background">
        ...
        {/* Message animation */}
        <motion.div
          className="max-w-150 bg-background text-xs font-light lg:text-s rounded-full bottom-30 lg:bottom-80 overflow-hidden flex items-center justify-center cursor-pointer absolute"
          style={{
      ...
      {/* Chapter main page section. */}
      <div className="w-full bg-[#181b21]">
        <div className="p-20">
          <div className="bg-background/10">
            {/* TODO: Make backgroubnd animation on scroll. */}
            <h2 className="thunder-bold text-secondary-foreground leading-30 text-[150px] lg:text-[240px] lg:leading-50 relative bottom-10 right-5">
      ...
      <footer className="w-full h-screen bg-background p-20 flex items-center justify-center">
        <h2 className="thunder-bold leading-20 text-[100px] lg:text-[180px] lg:leading-50">
